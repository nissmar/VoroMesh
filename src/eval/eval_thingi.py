...
if __name__ == '__main__':
    for pred_dir in os.listdir(pred_dirs):
        if 'direct' in pred_dir and (not '.' in pred_dir):
            pred_dir = pred_dirs+pred_dir+'/'
            ...
            for idx in range(obj_names_len):
                ...
                gt_obj_name = gt_dir + obj_names[idx] + ".obj"
                pred_obj_name = pred_dir + obj_names[idx] + ".obj"
                list_of_list_of_names[process_id].append(
                    [process_id, idx, gt_obj_name, pred_obj_name])
